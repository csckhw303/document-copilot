...
cd backend
uv sync
uv add fastapi uvicorn pydantic pydantic-settings httpx structlog openai supabase sqlalchemy alembic "psycopg[binary]" pgvector langchain-openai langgraph
