"""Initial schema with users, chat threads, messages, citations, documents, and chunks

Revision ID: 55738464ab01
Revises: 
Create Date: 2026-06-08 09:26:35.056641
...
def upgrade() -> None:
    ...
    # Drop indexes on document_chunks before dropping the table
    ...
    # Drop pgvector extension (optional - uncomment if needed)
